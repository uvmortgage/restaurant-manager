    ...
    <div className="flex flex-col h-full w-full max-w-xl mx-auto p-4 sm:p-6 animate-fadeIn">
      ...
      <div className="bg-ibg-600 rounded-3xl p-4 mb-6 flex items-center justify-between shadow-lg shadow-ibg-200">
        ...
        <div className="text-right">
          ...
          <p className="text-white/60 text-[9px] font-medium uppercase tracking-wider">
            {isSuperAdminUser ? 'Super Admin' : user.role}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        {isSuperAdminUser && (
          <button
            ...
            className="w-full text-left bg-ibg-600 rounded-3xl p-6 shadow-sm border border-ibg-500 flex items-center gap-5 hover:bg-ibg-700 hover:shadow-md transition-all active:scale-[0.98]"
          >
            ...
            <div className="flex-1">
              <p className="text-white/70 text-[9px] font-black uppercase tracking-widest mb-0.5">Platform Control</p>
              <h3 className="text-white font-black text-sm">Admin Panel</h3>
              <p className="text-white/60 text-xs font-medium mt-1">Restaurants, users & access</p>
            </div>
        ...
        <button
          ...
          className="w-full text-left bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex items-center gap-5 hover:border-orange-300 hover:shadow-md transition-all active:scale-[0.98]"
        >
        ...
        {isOwner && (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-2xl font-black text-emerald-600">${balance.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
            </div>
            <div className="text-slate-300">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
            </div>
        ...
        {isOwner && (
          <button
            ...
            className="w-full text-left bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex items-center gap-5 hover:border-rose-300 hover:shadow-md transition-all active:scale-[0.98]"
          >
        ...
        <button
          ...
          className="w-full text-left bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex items-center gap-5 hover:border-sky-300 hover:shadow-md transition-all active:scale-[0.98]"
        >
      ...
      <footer className="mt-auto pt-10 text-center space-y-1">
        ...
        <p className="text-slate-400 text-[9px] font-medium uppercase tracking-widest flex items-center justify-center gap-2">
          RestoHub v9.2
          <span className="w-1.5 h-1.5 rounded-full bg-ibg-500 animate-pulse"></span>
        </p>
      </footer>
    </div>
  );
